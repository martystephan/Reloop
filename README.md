...
```
packages/core      @reloop/core     framework-agnostic client (transport, batching, retry)
packages/react     @reloop/react    <ReloopProvider>, useFeedback(), <FeedbackWidget>
packages/vue       @reloop/vue      ReloopPlugin, useReloop(), <FeedbackWidget>
packages/vanilla   @reloop/vanilla  script-tag embeddable widget (auto-init)
...
examples/react-demo  Vite app exercising @reloop/react end-to-end
```
