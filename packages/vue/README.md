...
Vue bindings for the [Reloop](https://martystephan.github.io/Reloop/) SDK: a plugin, a `useSubmit()` composable, and a drop-in `FeedbackWidget`.
...
Returns the underlying [`@reloop-sdk/core`](https://martystephan.github.io/Reloop/sdk/core) client:
